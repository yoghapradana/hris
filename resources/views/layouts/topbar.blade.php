    ...
    <ul class="navbar-nav ml-auto">
        ...
        <li class="nav-item dropdown no-arrow">
            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown"
                ...
                @php
                    $imgPath = auth()->user()?->profile?->img_profile_path;
                    $src = $imgPath
                        ? Storage::url($imgPath)
                        : Storage::url(config('custom.img_path') . config('custom.default.img.user.profile.m'));
                @endphp
                <!-- User Profile Icon -->
                <img class="img-profile rounded-circle" src= "{{ $src }}" alt="">
...
<!-- Hidden form somewhere in your page (usually at bottom of body) -->
